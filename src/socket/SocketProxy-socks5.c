...
Client sends greeting with supported auth methods


Server responds with selected method


If method 0x02, client sends username/password auth


Server responds with auth status


Client sends connect request with target address


Server responds with connection status and bound address
